...
#PBS -N c_unigate
#PBS -o /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/uniform_gate.out
#PBS -e /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/uniform_gate.err
...
echo "============================================================"
echo "TriPoseFusion corrected retrain: uniform_gate"
