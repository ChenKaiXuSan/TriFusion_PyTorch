...
#PBS -N c_looctl
#PBS -o /work/SKIING/chenkaixu/code/TriFusion_fast/logs/pegasus/loo_control.out
#PBS -e /work/SKIING/chenkaixu/code/TriFusion_fast/logs/pegasus/loo_control.err

# 修正版重训（worktree-review-fixes 修复后代码）：canonicalizer 回退 / 门控熵 /
# Procrustes 修复后的 Table 4 重跑。代码 checkout: TriFusion_fast（分支 rebuttal-work）。
...
echo "============================================================"
echo "TriPoseFusion corrected retrain: loo_control"
