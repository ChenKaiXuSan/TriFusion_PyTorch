...
#PBS -N c_lam0
#PBS -o /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/full_gate_lambda0.out
#PBS -e /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/full_gate_lambda0.err
...
PROJECT_DIR=/work/SKIING/chenkaixu/code/TriFusion_corrected
cd "${PROJECT_DIR}"
...
echo "============================================================"
echo "TriPoseFusion corrected retrain: full_gate_lambda0"
...
devices=${DEVICES:-1}
fold=0
experiment_name=full_gate_lambda0
