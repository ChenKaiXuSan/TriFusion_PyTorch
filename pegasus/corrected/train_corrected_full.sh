...
#PBS -N c_full
#PBS -o /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/full.out
#PBS -e /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/full.err
...
echo "============================================================"
echo "TriPoseFusion corrected retrain: full"
