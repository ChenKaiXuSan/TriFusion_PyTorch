...
#PBS -N c_loo
#PBS -o /work/SKIING/chenkaixu/code/TriFusion_fast/logs/pegasus/loo.out
#PBS -e /work/SKIING/chenkaixu/code/TriFusion_fast/logs/pegasus/loo.err
...
echo "============================================================"
echo "TriPoseFusion corrected retrain: loo"
...
python TriPoseFusion/train.py \
  ...
  model.loo_teacher=true \
  model.lambda_info_nce=0.01 \
  train.val_check_interval=0.25 \
  train.monitor_metric=val/loo_mpjpe \
