...
#PBS -N c_base
#PBS -o /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/base_simple.out
#PBS -e /work/SKIING/chenkaixu/code/TriFusion_corrected/logs/pegasus/base_simple.err
...
echo "============================================================"
echo "TriPoseFusion corrected retrain: base_simple"
